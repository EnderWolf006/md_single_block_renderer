// Copied from https://github.com/Infinitix-LLC/gpt_markdown/blob/main/lib/custom_widgets/selectable_adapter.dart
...
class SelectableAdapter extends StatelessWidget {
  const SelectableAdapter({super.key, required this.child, required this.selectedText});
